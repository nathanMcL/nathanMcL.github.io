...
I have Python scripts that run on the server to track the AI model's budget (It does not fetch the budget data from within the OpenAI account. It's simply hardcoded).<br>
...
![Me Orb Output](https://user-images.githubusercontent.com/nathanMcL.github.io/images/MeOrbOutput.png)
<br>
